...
public class DividerItemDecoration extends ItemDecoration {
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        int childCount = parent.getChildCount() - 1; // No divider after the last item

        Set<Integer> skipSet = ((BaseListAdapter<MenuRow>)parent.getAdapter()).getItemSeparatorSkipSet();
