...
# TODO Requires proguard-android-optimize.txt otherwise logs won't be removed
# Strip all logcat logs
...
-assumenosideeffects class kotlin.jvm.internal.Intrinsics {
    ...
    private static void throwParameterIsNullIAE(...);
    private static void throwParameterIsNullNPE(...);
}

-keep class digital.paynetics.phos.classes.CrashlyticsAppender { *; }
